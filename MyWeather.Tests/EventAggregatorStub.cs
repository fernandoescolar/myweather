namespace MyWeather.Mvvm.Events
{
	...
	public class EventAggregatorStub : Stub<IEventAggregator>, IEventAggregator
	{
		...
		{
			private readonly EventAggregatorStub parent;
			internal CountCallers(EventAggregatorStub parent)
			{
				this.parent = parent;
			}
			...
			public class CountCallerMethods
			{
				...
				internal CountCallerMethods(EventAggregatorStub parent, int count)
				{
					this.parent = parent;
					this.count = count;
				}
		...
		{
			private readonly EventAggregatorStub parent;
			internal CountCalls(EventAggregatorStub parent)
			{
				this.parent = parent;
			}
			...
			public class CountCallsMethods
			{
				...
				internal CountCallsMethods(EventAggregatorStub parent, int position)
				{
					this.parent = parent;
		...
		{
			private readonly EventAggregatorStub parent;
			internal Handlers(EventAggregatorStub parent)
			{
				this.parent = parent;
			}
