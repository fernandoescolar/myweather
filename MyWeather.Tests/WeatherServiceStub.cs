namespace MyWeather.Core.Services
{
	...
	public class WeatherServiceStub : Stub<IWeatherService>, IWeatherService
	{
		...
		{
			private readonly WeatherServiceStub parent;
		...
		{
			private readonly WeatherServiceStub parent;
			internal CountCalls(WeatherServiceStub parent)
			{
				this.parent = parent;
			}
